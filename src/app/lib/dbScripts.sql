...
INSERT INTO transactions (transaction_id, group_id, user_id, date, description, amount,transaction_icon)
VALUES ('uuidT7', 'uuid2G', 'uuid1', '2023-12-04 15:15:47', 'ITV', 45.50, 'garage_icon');

INSERT INTO transactions (transaction_id, group_id, user_id, date, description, amount,transaction_icon)
VALUES ('uuidT8', 'uuid2G','uuid1', '2023-12-04 15:18:47', 'soporte telefono', 23.00, 'shopping_icon');

INSERT INTO transactions (transaction_id, group_id, user_id, date, description, amount,transaction_icon)
VALUES ('uuidT9', 'uuid2G', 'uuid2', '2023-12-04 15:20:47', 'Seguro', 55.25, 'bill_icon');

INSERT INTO transactions (transaction_id, group_id, user_id, date, description, amount,transaction_icon)
VALUES ('uuidT10', 'uuid2G', 'uuid2', '2023-12-04 15:27:47', 'Gasolina', 13.25, 'petrol_icon');

INSERT INTO transactions (transaction_id, group_id, user_id, date, description, amount,transaction_icon)
VALUES ('uuidT11', 'uuid2G','uuid1', '2023-12-04 15:30:47', 'Peaje', 10.99, 'tax_icon');

INSERT INTO transactions (transaction_id, group_id, user_id, date, description, amount,transaction_icon)
VALUES ('uuidT12', 'uuid2G', 'uuid2', '2023-12-04 15:32:47', 'Bombilla', 5.99, 'shopping_icon');
